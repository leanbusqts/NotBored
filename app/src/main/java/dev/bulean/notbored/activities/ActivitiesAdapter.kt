...
class ActivitiesAdapter(private val activities: List<TypesActivities>, private val onClickListener: (TypesActivities) -> Unit):
    ...
    class ActivitiesViewHolder(view: View): RecyclerView.ViewHolder(view) {
        ...
        fun bind(activities: TypesActivities, onClickListener: (TypesActivities) -> Unit){
